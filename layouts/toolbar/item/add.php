...
$buttons   = array_diff(['submit','submitAndNew','submitAndClose','cancel'], $hide);
...
<a href="<?php echo $backRoute; ?>"
   role="button"
   class="btn btn-sm btn-cancel btn-link align-top pl-0 pr-3"
...
<?php /***   S A V E  &  N E W   -   B U T T O N   ***/ ?>
<?php if (in_array('submitAndNew', $buttons)) : ?>
<div class="d-none d-lg-inline-block align-top ml-3">
	<div class="input-group">
		...
		<button type="submit"
				...
				name="button"
				value="submitAndNew"
				class="btn btn-sm btn-custom btn-submit btn-saveAndNew pr-md-3 allow-window-unload"
		>
			<span title="<?php echo Text::translate('COM_FTK_BUTTON_TITLE_SAVE_CHANGE_AND_ADD_TEXT', $lang); ?>"
				  aria-label="<?php echo Text::translate('COM_FTK_BUTTON_TITLE_SAVE_CHANGE_AND_ADD_TEXT', $lang); ?>"
				  data-toggle="tooltip"
			>
				<span class="btn-text ml-md-1 ml-lg-2 text-<?php echo ($lang == 'de') ? 'capitalize' : 'lowercase'; ?>"><?php
					echo mb_strtolower( Text::translate('COM_FTK_BUTTON_TEXT_SAVE_AND_ADD_TEXT', $lang) );
				?></span>
			</span>
		</button>
	</div>
...
<div class="d-none d-xl-inline-block align-top ml-3">
	<div class="input-group">
		<div class="input-group-prepend">
			<span class="input-group-text">
...
<div class="d-inline-block align-top ml-3">
	<div class="input-group">
		...
		<a href="<?php echo UriHelper::osSafe( UriHelper::fixURL( (new Uri($backRoute))->toString() ) ); ?>"
