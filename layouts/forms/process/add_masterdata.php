...
<div class="row ml-md-0">
	<div class="col">
		<div class="row form-group">
			...
			<label for="abbreviation" class="col col-form-label col-md-2 text-md-right"><?php echo Text::translate('COM_FTK_LABEL_ABBREVIATION_TEXT', $this->language); ?>:&nbsp;&ast;</label>
			<div class="col col-6 col-md-2">
				<input type="text"
					   name="abbreviation"
					   value="<?php echo ArrayHelper::getValue($this->formData, 'abbreviation', '', 'STRING'); ?>"
					   class="form-control"
					   minlength="3"
					   maxlength="5"
					   placeholder="<?php echo Text::translate('COM_FTK_INPUT_PLACEHOLDER_REQUIRED_TEXT', $this->language); ?>"
