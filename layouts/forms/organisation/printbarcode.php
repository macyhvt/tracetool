...
$userIDs = $query_params['uid'] ?? '';
$useRoleGet = $model->getInstance('user', ['language' => $this->language])->getActiveUserRole($userIDs);
        ...
        <div class="col-md-6 frontlogincard">
            ...
            <div class="row">
                <div class="col-md-12 empLoginName">
                    <img class="userLoginName" src="<?php echo $actual_link;echo UriHelper::osSafe(UriHelper::fixURL(sprintf('barcode.php'))); ?>?s=dmtxr&wq=4&d=<?php echo $email; ?>">
                </div>
            </div>
