...
<div class="row ml-md-0">
	<div class="col">
		<div class="row form-group">
			<label for="number" class="col col-form-label col-md-2"><?php echo Text::translate('COM_FTK_LABEL_PROJECT_NUMBER_TEXT', $this->language); ?>:&nbsp;&ast;</label>
			...
			<div class="col">
				...
				>
					...
					<?php	echo sprintf('<option value="%s"%s>%s</option>',
						$abbr,
						($abbr === ArrayHelper::getValue($this->formData, 'status', '', 'CMD') ? ' selected' : ''),
		...
		<div class="row form-group">
			...
			<div class="col">
				<input type="text"
					   name="customer"
					   value="<?php echo ArrayHelper::getValue($this->formData, 'customer', '', 'CMD'); ?>"
					   class="form-control"
					   minlength="1"
					   maxlength="100"
					   <?php // Note: The title attribute is used as the error message if the user input does not match the pattern. Hence, it is mandatory. ?>
