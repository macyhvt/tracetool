...
<table class="table table-bordered" id="processMatrix" border="0" cellpadding="0" cellspacing="0">
	...
	<?php foreach ($articles as $artID => $article) : ?><?php
		...
		?>
		<tr>
			<td scope="row" class="text-center align-middle"     style="font-family:Calibri; font-size:8px; text-transform: uppercase">.<?php echo html_entity_decode($procname); ?></td>
			...
			?></td>
			<td             class="text-center align-middle pms" style="font-family:Arial;   font-size:9px;text-transform: uppercase">pms</td>
			...
			?>
			<td class="text-center align-middle matrix-cell-<?php echo $process->get('abbreviation'); ?>" style="font-family:Arial; font-size:9px;text-transform: uppercase"><?php
