 ...
 * Class description
 */
class Fmeas extends ListView
{
	use \ \Traits\View\Roles;
	...
	protected function checkAccess() : void
	{
		...
		if ($this->user->getFlags() < \ \Access\User::ROLE_WORKER)
		{
			...
			Messager::setMessage([
				'type' => 'notice',
				'text' => Text::translate('COM_FTK_ERROR_APPLICATION_VIEW_ACCESS_DENIED_TEXT', $this->language) . ($this->user->isProgrammer() ? ' (#12)' : '')
			]);
