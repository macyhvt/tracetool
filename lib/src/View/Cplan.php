 ...
 * Class description
 */
class Cplan extends ItemView
{
	use \Nematrack\Traits\View\Cplan;
	...
	{
		return $this->identificationKey = 'cpid';
	}
	...
	protected function checkAccess() : void
	{
		...
		if ($this->user->getFlags() < \Nematrack\Access\User::ROLE_WORKER)
		{
			...
			Messager::setMessage([
				'type' => 'notice',
				'text' => Text::translate('COM_FTK_ERROR_APPLICATION_VIEW_ACCESS_DENIED_TEXT', $this->language) . ($this->user->isProgrammer() ? ' (#7)' : '')
			]);
